...
+ ¿Por qué se demoró significativamente el reintegro del dinero de las compras que la empresa misma canceló? Recordamos que hay una compra a principios de Diciembre y otra a finales del mismo mes. Y es más nos reintegraron primero el monto de la segunda compra.
...
Los primeros nodos que se encendieron, fueron los N37. Aquí cometimos nuestro primer error, a 5 minutos de haber encendido el dispositivo. Intentamos flashear el firmware vía bluetooth, algo que no se puede hacer desde la app de Android, por lo menos a la fecha de publicación de este artículo (y no es que no se pueda en la actualidad, pero nosotros no quisimos ahondar en este proceso por ahora), pero que en su momento nosotros sabíamos, lo que derivó en que el dispositivo se 'rompa'. Pero lo arreglamos a la brevedad.
